...
Dated note, 2026-09-05: the schedule below compressed on 2026-09-02, the collect-only window closed on 2026-09-06 and the first apply pile landed that Sunday, and the review of 2026-09-05 moved the target to product motion and motion systems. The milestone table is history; `docs/search-protocol.md` and the session log carry the current state.
